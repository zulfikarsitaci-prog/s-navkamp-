...
<style>
    ...
    /* --- 2. ÜST MENÜ (TEK SATIR, KAYDIRILABİLİR, OKUNAKLI) --- */
    
    div[role="radiogroup"] {
        display: flex !important;
        flex-direction: row !important;
        flex-wrap: nowrap !important; /* ASLA alt satıra geçme */
        overflow-x: auto !important;   /* Yana kaydırmaya izin ver */
        gap: 8px !important;
    ...
    div[role="radiogroup"] label {
        ...
        min-width: fit-content !important; /* İçerik kadar genişle */
        margin: 0 !important;
        display: flex !important;
    ...
    /* Menü Yazıları (NET OKUNURLUK) */
    div[role="radiogroup"] label p {
        color: #FFD700 !important; /* PARLAK GOLD */
        font-weight: 800 !important;
        font-size: 1rem !important;
        margin: 0 !important;
        white-space: nowrap !important; /* Yazı asla taşmasın */
        text-shadow: 0px 1px 2px rgba(0,0,0,0.8); /* Okunurluk için gölge */
    }
    ...
    div[role="radiogroup"] label[data-checked="true"] p {
        color: #000000 !important; /* Seçilince SİYAH */
    }

    /* --- 3. HİKAYELER (INSTAGRAM TARZI - SOLA YASLI) --- */
    
    /* Hikaye butonu içeren kolonları yakala ve ZORLA DARALT */
    div[data-testid="column"]:has(.story-btn) {
        flex: 0 0 auto !important;  /* Genişleme! */
    ...
    /* Hikayelerin olduğu satırı SIKIŞTIR ve SOLA YASLA */
    div[data-testid="stHorizontalBlock"]:has(.story-btn) {
        display: flex !important;
        flex-wrap: nowrap !important;
        overflow-x: auto !important;
        justify-content: flex-start !important; /* Sola Yapıştır */
        gap: 2px !important; /* Aralarındaki boşluk */
        padding-bottom: 5px !important;
    }

    /* Görünmez Buton Hack'i */
    .story-btn button {
        ...
        width: 75px !important; /* Kolonla aynı genişlik */
    ...
    /* --- 4. POST KARTI VE BUTONLARI --- */
    
    /* + Butonu (Popover) Yukarı Çekme */
