...
<style>
    ...
    .login-main { 
        font-family: 'Cinzel', serif; /* İSTEK ÜZERİNE CİNZEL YAPILDI */
        color: #FFD700; 
        font-size: 2.5rem; 
    ...
    /* POST KARTI (KOYU TON) */
    .post-card {
        background-color: #1e293b; /* KOYU LACİVERT GERİ GELDİ */
    ...
    .icon-btn span { font-size: 0.8rem; font-weight: bold; }
