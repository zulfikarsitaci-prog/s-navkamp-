...
if st.session_state.ekran == 'giris':
    ...
    with c2:
        ...
        st.markdown("<div class='imza-container'><div class='imza-baslik'>Muhasebe ve Finansman Öğretmenleri</div><div class='imza'>Z. SITACI & M BAĞCIK</div>Desteklerinden dolayı sevgili dostum Mehmet KARADUMAN' a teşekkür ederim. </div>", unsafe_allow_html=True)
