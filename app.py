...
<style>
    ...
    .login-sub { color: #e2e8f0; font-size: 1rem; margin-bottom: 5px; font-family: sans-serif; }
    .login-main { 
    ...
    .login-bottom { color: #94a3b8; font-family: 'Cinzel', serif; font-size: 1.2rem; margin-top: 5px; }
